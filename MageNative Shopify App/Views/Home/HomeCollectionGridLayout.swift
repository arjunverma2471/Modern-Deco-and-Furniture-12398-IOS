...
extension HomeCollectionGridLayout:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if viewModel?.item_title == "1"{
            ...
            var size = collectionView.calculateCellSize(numberOfColumns: 3,of: 75, imagesize: imageSize, spacing: 25)
            ...
            let size = collectionView.calculateCellSize(numberOfColumns: 3,of: 75, imagesize: imageSize, spacing: 25)
            return size;
        }
    }
}
