...
//                self.tableView.reloadData()
    ...
    func setupTable(){
        ...
        tableView.register(RecommendationsTableCell.self, forCellReuseIdentifier: RecommendationsTableCell.className)
...
extension CartViewController {
    ...
    func getArgoidRecommendations(checkout:CheckoutViewModel) {
