...
class ProductVC : BaseViewController,SelectedProductDelegate {
    ...
    var argoidRecommendationsView = ProductRecommendedView()
    var argoidRecentlyViewed = ProductRecommendedView()
    var argoidStyledProducts = ProductRecommendedView()
    // ----------------------------------
    //  MARK: - Views -
    //
...
//        }
    ...
    func perform() {
        ...
        if customAppSettings.sharedInstance.argoidRecommendations {
            self.getArgoidSimilarProducts()
            self.getArgoidSRecentProducts()
            self.getArgoidStyledProducts()
        }
